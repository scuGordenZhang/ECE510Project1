...
class Tap_GPIO():
    ...
    def __init__(self):
        ...
        self.setup_time = 0.1           # set up time, hold time
    
        GPIO.setwarnings(False)
        GPIO.setmode(GPIO.BCM)          # board numbering base on Broadcom SOC

        # TMS: RPi ---> TAP
        GPIO.setup(TMS, GPIO.OUT)       # setting up all channels using as an input or an output
        # TDI: RPi ---> TAP
